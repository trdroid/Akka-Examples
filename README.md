...
```sh
activator-dist-1.3.10/bin$ ./activator list-templates
...
Other Seed Templates:
  ...
  primitive-scala-scalatest-seed
  reactive-play-scala-akka-slick-guice-domain_validation-seed
  reactive-salesforce-rest-javascript-seed
  salesforce-canvas-seed
  sbt-plugin-seed
...
Other Tutorial Templates:
  ...
  play-cake
  play-elastic-beanstalk
  play-elasticsearch-autocomplate
  play-embedded
  play-entitytled-simple
  play-example-form
  play-guice
  ...
  play-oauth2-scala
  play-quill-jdbc
  play-react-scalikejdbc-postgres-bootstrap4
  play-reactive-mongo
  play-reactive-mongo-db
  play-reactivemongo-polymer
  play-restfb-jaba
  ...
  signalj-chat-java
  signalj-chat-scala
  simple-akka-http-websocket-example
  six-minute-apps
  skalholt
  skinny-orm-in-play
  slick-active-record
